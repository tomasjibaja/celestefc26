...
const lyrics = [
  ...
  { time: 60,  text: "se estruja mi corazón" },
  { time: 63,  text: "cuando cruzás la puerta" },
  { time: 69,  text: "será que es tan natural" },
  { time: 71,  text: "tu forma de amar" },
  { time: 74,  text: "tu mano en mi pelo" },
  { time: 77,  text: "tu marca en mi piel" },
  { time: 79,  text: "tu aroma" },
  { time: 81,  text: "mejor paro acá" },
  { time: 84,  text: "mejor le pido a esta mañana" },
  { time: 87,  text: "que mañana también digas sí" },
  { time: 92,  text: "tengo un container lleno de" },
  { time: 96,  text: "momentos por vivir" },
  { time: 99,  text: "y así le pido a esta mañana" },
  { time: 103, text: "que esta noche" },
  { time: 105, text: "vuelva a estar así" },
  { time: 108, text: "para regalarte otro momento" }
];
